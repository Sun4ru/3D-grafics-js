class Cube {
    ...
    constructor(centerPoint, radius, div){
        ...
        //this.ToSphere(this.FrontPoints);
        ...
        //this.ToSphere(this.RIGHTPoints);
        ...
        //this.ToSphere(this.BOTTOMPoints);
    ...
    ToSphere(PointList){
        for (let point of PointList){
            let center_to_point = new Vec4(point.x-this.centerPoint.x, point.y-this.centerPoint.y, point.z-this.centerPoint.z, 1);
            let normalized_vec = center_to_point.normalizedVec();
            PointList[PointList.indexOf(point)] = normalized_vec;
        }
    }
}
